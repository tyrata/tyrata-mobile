...
public class Constants {
        public static final String TAG = "tyrata";
        ...
        public static final String AD7747_MODE = "ad7747-mode";

        public static final String RF_DB = "rf";
        public static final String AD7747_DB = "ad7747";
        ...
        public static final String RF_ID = "1";
        public static final String AD7747_ID = "0";

        public static final String RF_MAP_KEY = "Frequency";
        public static final String AD7747_MAP_KEY = "Capacitance";
        public static final String TIME_MAP_KEY = "Time";
        public static final String TEMP_MAP_KEY = "Temperature";
        public static final String VOLTAGE_MAP_KEY = "Voltage";
        ...
        public final static String SENSOR_BASE = "Tyrata_0";

        public final static String CAPDACA = "0B";
}
